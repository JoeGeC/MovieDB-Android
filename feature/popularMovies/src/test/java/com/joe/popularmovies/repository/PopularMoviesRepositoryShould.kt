...
//        whenever(local.get(MockObjects.PAGE_1)).thenReturn(MockResponse.success)
//
...
//        whenever(local.get(MockObjects.PAGE_1)).thenReturn(MockResponse.emptySuccess)
...
//        }
//
//        verify(local).insert(MockResponse.popularMovies)
//    }
//
//    @Test
//    fun `emit error when remote and local both fail`() = runTest {
//        whenever(local.get(MockObjects.PAGE_1)).thenReturn(MockResponse.failure)
...
//        whenever(local.get(MockObjects.PAGE_1)).thenReturn(MockResponse.nullMovieDataSuccess)
//        whenever(remote.getPopularMovies(MockObjects.PAGE_1)).thenReturn(MockResponse.success)
//
//        repository.getPopularMovies(MockObjects.PAGE_1).test {
//            val emitted = awaitItem()
...
//        whenever(local.get(MockObjects.PAGE_1)).thenReturn(MockResponse.nullDataSuccess)
//        whenever(remote.getPopularMovies(MockObjects.PAGE_1)).thenReturn(MockResponse.success)
//
//        repository.getPopularMovies(MockObjects.PAGE_1).test {
//            val emitted = awaitItem()
